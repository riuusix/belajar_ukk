                        ...
                        <div class="white-box">
                            <form method="post" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_ktp" class="form-control" value="<?= $member['no_ktp'] ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alamat_member" class="form-control" value="<?= $member['alamat_member'] ?>">
                                </div>
                                <div class="form-group">
                                    <label>No Telepon</label>
                                    <input type="text" name="telp_member" class="form-control" value="<?= $member['telp_member'] ?>">
                                </div>
                                <div class="form-group">
                                    <label>Jenis Kelamin</label>
                                    <select name="jenis_kelamin" class="form-control">
                                        <option value="<?= $member['jenis_kelamin'] ?>" selected><?= $member['jenis_kelamin'] == 'L' ? 'Laki-Laki' : 'Perempuan' ?></option>
