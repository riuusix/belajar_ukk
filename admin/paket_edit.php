...
$id = $_GET["id"];
$paket = query("SELECT * FROM tb_paket WHERE id_paket = $id")[0];
$outlet = query("SELECT id_outlet, nama_outlet FROM tb_outlet");
                        ...
                        <div class="white-box">
                            <form method="post" action="">
                                <div class="form-group">
                                    <input type="hidden" name="id_paket" class="form-control" value="<?= $paket['id_paket'] ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_paket" class="form-control">
                                        <option value="kiloan" selected><?= $paket['jenis_paket'] ?></option>
