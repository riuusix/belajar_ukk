...
if (isset($_POST['btn-simpan'])) {
    if (tambah_user($_POST) > 0) {
        echo "<script>alert('Data Berhasil Ditambahkan'); window.location.href='pengguna.php';
        </script>";
    } else {
        echo "<script>alert('Data Gagal Ditambahkan'); window.location.href='pengguna.php';
        </script>";
