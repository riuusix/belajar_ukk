                        ...
                        <div class="white-box">
                            <form method="post" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= $outlet['nama_outlet'] ?>" name="nama_outlet" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Alamat Outlet</label>
                                    <textarea name="alamat_outlet" class="form-control"><?= $outlet['alamat_outlet'] ?></textarea>
                                </div>
                                <div class="form-group">
