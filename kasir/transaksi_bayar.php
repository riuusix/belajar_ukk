...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                <form method="post" action="transaksi_bayar.php?id=39" id="form-submit">
                <div class="form-group">
                    <label>Kode Invoice</label>
                    <input type="text" name="kode_invoice" value="DRY202501221500" class="form-control" readonly>
                </div>
                <div class="form-group">
                    <label>Nama Member</label>
                    <input type="text" name="nama_member" value="Kailendra" class="form-control" readonly>
                </div>
                <div class="form-group">
                    <label>Total Yang Harus Di Bayar</label>
                    <input type="text" name="total_harga" value="56000" class="form-control" readonly>
                </div>
                <div class="form-group">
