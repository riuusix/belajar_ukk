...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table ">
                        ...
                        <tbody>
                                 <tr>
        <td>1</td>
        <td>DRY202501221500</td>
        <td>Kailendra</td>
        <td>baru</td>
        <td>dibayar</td>
        <td>56000</td>
        <td align="center">
            <a href="transaksi_detail.php?id=39"
        ...
        <td>120000</td>
        <td align="center">
            <a href="transaksi_detail.php?id=38"
               data-toggle="tooltip" data-placement="bottom" title="Edit" class="btn btn-success btn-block">Detail</a>
        </td>
    </tr>
                         <tr>
        ...
        <td>60000</td>
        <td align="center">
            <a href="transaksi_detail.php?id=37"
               data-toggle="tooltip" data-placement="bottom" title="Edit" class="btn btn-success btn-block">Detail</a>
        </td>
    </tr>
                         <tr>
        ...
        <td>100000</td>
        <td align="center">
            <a href="transaksi_detail.php?id=36"
               data-toggle="tooltip" data-placement="bottom" title="Edit" class="btn btn-success btn-block">Detail</a>
        </td>
    </tr>
